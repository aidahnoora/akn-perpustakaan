  ...
  >
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          url="/petugas"
          :class="getRoute() === 'petugas' ? 'active' : ''"
          navText="Data Petugas"
        >
          <template v-slot:icon>
            <i class="fas fa-user-circle text-danger text-sm opacity-10"></i>
          </template>
        </sidenav-item>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <sidenav-item
          url="/anggota"
          :class="getRoute() === 'anggota' ? 'active' : ''"
          navText="Data Anggota"
        >
          <template v-slot:icon>
